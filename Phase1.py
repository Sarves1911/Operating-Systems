...
M = [['\0' for i in range(4)] for j in range(100)] # 2d array of size 100 rows 4 coloumns with each element null
buffer = ['\0' for i in range(40)] #buffer creation
...
def main():
    if os.path.exists("C://Users//lokis//OneDrive//Desktop//input.txt"):
        print("File Exists")
        global fi,fo
        fi=open("C://Users//lokis//OneDrive//Desktop//input.txt","r")
        fo=open("C://Users//lokis//OneDrive//Desktop//output.txt","w")   
    else:
